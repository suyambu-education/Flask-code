...
if(h.zero===true)
	{
		if(b==0)
		{
			myregex = /^[0-9][0-9]{0,3}$|^[0-9][0-9]{0,3}[\.][0-9]$/;
			if(!myregex.test($(b).val()) || $(b).val()=="0")
			{
    				return[false,j+": "+a.jgrid.edit.msg.zero,""];
			}
		}
	}
if(h.codemax===true)
...
{
 return[false,j+": "+a.jgrid.edit.msg.codemax,""];
}
}
if(h.marks===true)
{
...
{
 return[false,j+": "+a.jgrid.edit.msg.marks,""];
}
}
...
if(h.max===true)
{
	...
	else
	{
		...
		{
 		return[false,j+": "+a.jgrid.edit.msg.max,""];
		}
...
{
 return[false,j+": "+a.jgrid.edit.msg.limit,""];
}
}
if(h.string===true)
{
...
if(!v.match(/^[^.][A-Za-z.]*[^.]$/)) 
{
       return[false,j+":"+a.jgrid.edit.msg.string,""];
}
}
if(h.uname===true)
{
v=b;
if(!v.match(/^[^1-9][A-Za-z1-9]{7,19}$/)) 
{
       return[false,j+":"+a.jgrid.edit.msg.uname,""];
}
}
if(h.dis===true)
{
v=b;
if(!v.match(/^[^1-9,][A-Za-z,1-9\s]{19,99}$/)) 
{
       return[false,j+":"+a.jgrid.edit.msg.dis,""];
}
}
if(h.nname===true)
{
v=b;
if(!v.match(/^[^1-9][A-Za-z1-9\s]{7,24}$/)) 
{
       return[false,":"+a.jgrid.edit.msg.nname,""];
}
}
if(h.ename===true)
{
...
if(!v.match(/^[^1-9][A-Za-z1-9\s]{7,24}$/)) 
{
       return[false,":"+a.jgrid.edit.msg.ename,""];
}
}
if(h.facname===true)
{
v=b;
if(!v.match(/^[A-Za-z\s]{9,34}$/)) 
{
       return[false,a.jgrid.edit.msg.facname,""];
}
}
if(h.type===true)
{
...
if(!v.match(/^[A-Za-z]+$/)) 
{
       return[false,j+":"+a.jgrid.edit.msg.type,""];
}
}
if(h.name===true)
{
...
if(!v.match(/^[A-Za-z.]+$/)) 
{
       return[false,j+":"+a.jgrid.edit.msg.name,""];
}
}
if(h.subname===true)
{
v=b;
if(!v.match(/^[a-zA-Z][A-Za-z\s.&\s]*[\s]*[-]*[\s]*[1]*[2]*$/)) 
{
       return[false,j+":"+a.jgrid.edit.msg.subname,""];
}
}
if(h.limityear===true)
{
...
{
 return[false,j+": "+a.jgrid.edit.msg.limityear,""];
}
}
if(h.salary===true)
{
...
{
 return[false,j+": "+a.jgrid.edit.msg.salary,""];
}
}
if(h.no===true)
{
...
if( b >=min && b <=max )
{
...
else
	{
		...
		{
 		return[false,j+": "+a.jgrid.edit.msg.no,""];
		}
...
{
v=b;
if(!v.match(/^[a-zA-Z1-9][A-Za-z1-9,-][a-zA-Z,1-9]*$/)) 
{
       return[false,j+":"+a.jgrid.edit.msg.add,""];
}
}
if(h.add2===true)
{
...
if(!v.match(/^[a-zA-Z,]*$/)) 
{
       return[false,j+":"+a.jgrid.edit.msg.add2,""];
}
}
if(h.limitseat===true)
{
...
{
 return[false,j+": "+a.jgrid.edit.msg.limitseat,""];
}
}
if(h.emax===true)
{
...
{
 return[false,j+": "+a.jgrid.edit.msg.emax,""];
}
}
if(h.sub===true)
{
...
{
 return[false,j+": "+a.jgrid.edit.msg.sub,""];
}
}
if(h.markmax===true)
{
...
{
 return[false,j+": "+a.jgrid.edit.msg.markmax,""];
}
}
...
date  = Date1.substring(8,10);
myDate= new Date(year,month-1,date);
today = new Date();
if (myDate>today)
{
  return[false,j+": "+a.jgrid.edit.msg.cdate,""];
}
}
if(h.bdate===true)
if(!(f===false&&this.isEmpty(b)))
...
myDate= new Date(year,month-1,date);
today = new Date();
cyear = today.getFullYear()-18;
if (year>cyear)
{
  return[false,j+": "+a.jgrid.edit.msg.bdate,""];
}
}
if(h.sdate===true)
if(!(f===false&&this.isEmpty(b)))
...
myDate= new Date(year,month-1,date);
today = new Date();
cyear = today.getFullYear()-20;
if (year>cyear)
{
  return[false,j+": "+a.jgrid.edit.msg.sdate,""];
}
}
...
{
	return[false,j+": "+a.jgrid.edit.msg.mno,""];
}
}
...
{
	return[false,j+": "+a.jgrid.edit.msg.maxname,""];
}
}
if(h.date===true)
if(!(f===false&&this.isEmpty(b)))
...
if(h.url===true)if(!(f===false&&this.isEmpty(b))){g=/^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i;if(!g.test(b))return[false,j+": "+a.jgrid.edit.msg.url,""]}if(h.custom===true)if(!(f===false&&this.isEmpty(b)))if(a.isFunction(h.custom_func)){b=h.custom_func.call(d,b,j);return a.isArray(b)?
